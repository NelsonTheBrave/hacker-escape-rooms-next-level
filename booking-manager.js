export class BookingManager {
  ...
  async createBookingPage(challenge) {
    ...
    ('button','bookingSceneContainer__ContinueBtnID','bookingSceneContainer__ContinueBtnClass','Search available times',null);

    bookingSceneContainer__section.appendChild(bookingSceneContainer__ContinueBtn);

    //Creating return button
    const bookingSceneContainer__BackBtn = this.createElement('button','bookingSceneContainer__BackBtnID','bookingSceneContainer__BackBtnClass',null);
    ...
    bookingSceneContainer__ContinueBtn.addEventListener('click', async () => {
      ...
      bookingSceneContainer__section.style.display = 'none';const bookingSceneContainer__SecondSection = this.createElement
      ('div','bookingSceneContainer__SecondSectionID','bookingSceneContainer__SecondSectionClass',null,null);
      ...
      availableTimes.forEach(function (time) {const bookingScene__SecondRoomSelectTimeOption = document.createElement('option');
      ...
      const bookingScene__SecondRoomSelectParticipantsLabel = this.createElement
      ('label', 'bookingScene__SecondRoomSelectParticipantslabelID','bookingScene__SecondRoomSelectParticipantslabelClass','How many participants?',null);
      ...
      ('select','bookingScene__SecondRoomSelectParticipantsID','bookingScene__SecondRoomSelectParticipantsClass',null,null);
      ...
      ('button','bookingSceneContainer__SecondRoomSubmitBtnID','bookingSceneContainer__SecondRoomSubmitBtnClass','Submit booking',null);
      ...
      ('button','bookingSceneContainer__SecondRoomBackBtnID','bookingSceneContainer__SecondRoomBackBtnClass','',null);
      ...
      bookingSceneContainer__SecondRoomSubmitBtn.addEventListener('click',async () => {
        ...
        if (bookingScene__SecondRoomInputName.value === '' || bookingScene__SecondRoomInputEmail.value === '') {
          ...
          ('section','bookingSceneContainer__LastSectionID','bookingSceneContainer__LastSectionClass' ,null, null);
          ...
          ('h2','bookingSceneContainer__LastSectionh2ID','bookingSceneContainer__LastSectionh2Class','Thank You!',null);
