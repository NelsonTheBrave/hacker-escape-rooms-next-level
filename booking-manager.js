export class BookingManager {
  ...
  async createBookingPage(challenge) {
    ...
    bookingScene__DateInputLabel.setAttribute(
      'for',
    ...
    bookingSceneContainer__ContinueBtn.addEventListener('click', async () => {
      ...
      //Creating select-element for time selection,cant set attribute before creating selectElement. Something with the api fetch perhaps? Doable on the username/email elements.
